(function (t) {
    ...
    0: function (t, e, r) {
        ...
        var s = r("2b0e"), a = function () {
                ...
                }) : t._e()]), r("transition", {attrs: {name: "fademove"}}, [!0 === t.showPartners ? r("div", {staticClass: "partnersinfo"}, [r("a", {attrs: {href: "https://bit.ly/2VrMA3E"}}, [r("img", {
                ...
                }, [t._v("Почати гру!")])]) : t._e(), !0 === t.instructions ? r("div", [t._m(2), r("button", {
                    staticClass: "tetris__nextbutton",
                    on: {
                        click: function (e) {
                ...
                }), r("p", [t._v(" Південний вокзал відкрили в 2001 році, раніше на його місці розташовувався оптовий ринок. Архітектурні рішення нової будівлі були настільки незвичними для того часу, що після відкриття сюди водили шкільні екскурсії. ")]), r("p", [t._v(" Під час будівництва Південного вокзалу використовували "), r("a", {
                    attrs: {
                        href: "https://kovalska.com/beton-vid-kovalskoyi",
                        target: "_blank"
                    }
                }, [t._v("«Бетон від Ковальської»")]), t._v(". Група компаній "), r("a", {
                    attrs: {
                        href: "https://kovalska.com/beton-vid-kovalskoyi",
                        target: "_blank"
                    }
                ...
                }), r("p", [t._v(" Київський центральний універмаг збудований у стилі ар-деко. ЦУМ відкрили для перших відвідувачів у 1939 році. Це – одна з небагатьох будівель на Хрещатику, яка не була повністю зруйнована у ході другої світової й знову почала працювати у 1947 році після реконструкції. Це – перший магазин в Україні, де встановили ескалатор, ще в 1960 році. Тривалий час ЦУМ слугував символом «радянського достатку». ")]), r("p", [t._v(" В 2016 році універмаг реконструювали. В ході будівельних робіт використовували "), r("a", {
                    attrs: {
                        href: "https://kovalska.com/beton-vid-kovalskoyi",
                        target: "_blank"
                    }
                }, [t._v("«Бетон від Ковальської»")]), t._v(". Під куполом оновленої будівлі розташовані ресторани, кафе та бари з мальовничим видом на старий Київ. ")])]) : t._e(), 4 === t.step ? r("div", [r("h2", {staticClass: "win__header"}, [t._v(" Національна бібліотека України ім. Вернадського ")]), r("img", {
                    attrs: {
                        src: t.img.bibliofin,
                        alt: ""
                    }
                }), r("p", [t._v(" Бібліотека імені Вернадського – найбільша в Україні. Її відкрили в 1989 році, а на церемонію приїхав сам Борис Патон, президент НАН України. Один з її корпусів сягає 77 метрів заввишки і виконаний в стилі архітектури модернізму. ")]), r("p", [t._v(" Бібліотека складається з вертикальної споруди, де знаходяться книгосховища, й стилобату – з читальними залами, конференц залою та службовими приміщеннями. ")]), r("p", [t._v(" Її зводили за кресленнями «Київпроекту», а в ході будівництва використовували "), r("a", {
                    attrs: {
                        href: "https://kovalska.com/beton-vid-kovalskoyi",
                        target: "_blank"
                    }
                }, [t._v("«Бетон від Ковальської»")]), t._v(". ")]), r("p", [r("a", {
                    attrs: {
                        href: "https://kovalska.com/beton-vid-kovalskoyi",
                        target: "_blank"
                    }
                }, [t._v("ПБГ «Ковальська»")]), t._v(" має власну сертифіковану лабораторію, фахівці якої на кожному етапі перевіряють якість продукції і так само працюють над новими вдосконаленими рецептурами. Все це гарантує довговічність і надійність спорудам, зведених з "), r("a", {
                    attrs: {
                        href: "https://kovalska.com/beton-vid-kovalskoyi",
                        target: "_blank"
                    }
                }, [t._v("«Бетону від Ковальської»")]), t._v(". ")])]) : t._e(), 5 === t.step ? r("div", [r("h2", {staticClass: "win__header"}, [t._v(" БЦ Парус ")]), r("img", {
                    attrs: {
                        src: t.img.parusfin,
                        alt: ""
                    }
                }), r("p", [t._v(" БЦ Парус є однією з найвищих будівель Києва і сягає 133 метрів у висоту. Бізнес центр має 32 поверхи й будувався впродовж трьох років. Будівлю зводили з використанням скла, сталі, алюмінію, бетону, залізобетону й цегли. У ході робіт використовували матеріали від "), r("a", {
                    attrs: {
                        href: "https://kovalska.com/beton-vid-kovalskoyi",
                        target: "_blank"
                    }
                }, [t._v("ПБГ «Ковальська»")]), t._v(". ")])]) : t._e(), r("button", {
                    staticClass: "tetris__nextbutton",
                    on: {click: t.nextLevel}
                }, [t._v("Далі!")])]) : t._e(), !t.gameon || t.start || t.win ? t._e() : r("div", {staticClass: "loose"}, [r("h2", {staticClass: "loose__header"}, [t._v(" Вам не вдалося збудувати " + t._s(t.nameObject[t.step - 1]) + " :( ")]), r("button", {
                    staticClass: "tetris__nextbutton",
                    on: {
                        click: function (e) {
                            t.start = !0
                ...
                }, [t._v("Спробуйте ще раз!")])]), r("div", {staticClass: "tetris__rule"}, [r("div", {
                    attrs: {role: "button"},
                    on: {
                        click: function (e) {
                            return t.move(-1)
        ...
        var D = {
            name: "Tetris", data: function () {
                ...
                startTimer: function () {
                    ...
                    this.step < 5 ? (this.step += 1, this.win = !1, this.start = !0, this.$nextTick((function () {
